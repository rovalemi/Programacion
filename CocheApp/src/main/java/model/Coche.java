...
public class Coche {
    ...
    // Datos de fabrica
    public Coche(String brand, String model, int power, int seats, ColorEnum color, String motor, CombustibleEnum fuel, String manufacturing_date) {
        this.brand = brand;
        this.model = model;
        this.power = power;
        this.seats = seats;
    ...
    public Coche(String brand, String plate, String model, int power, int seats, ColorEnum color, String motor, double speed, CombustibleEnum fuel, String manufacturing_date) {
        this.brand = brand;
        this.plate = plate;
        this.model = model;
        this.power = power;
